...
env = environ.Env(
    ...
    SOCIAL_AUTH_TUNNISTAMO_REDIRECT_URI_OVERRIDE=(str, ""),
...
SOCIAL_AUTH_STRATEGY = "kerrokantasi.oidc.ReviewStrategy"
...
SOCIAL_AUTH_TUNNISTAMO_REDIRECT_URI_OVERRIDE = env("SOCIAL_AUTH_TUNNISTAMO_REDIRECT_URI_OVERRIDE")
